<template>
  <div class="home">
    ...
    <h1>This page will contain Friz dashboard 2.0.0</h1>
    <div class="home-users">
      <div
        class="home-users-profile"
        v-for="(profile, index) in USER_PROFILES"
        :key="index"
      >
        <router-link
          class="no-decoration"
          :to="{ name: 'UserScreen', params: { username: profile.username } }"
        >
          <UserProfileCompact
